...
import jax
from minimal_mjx.utils.setupGPU import get_submodule_location

SUBMODULE_LOCATION = get_submodule_location()
class CheetahInterface:
    XML         = Path(f'{SUBMODULE_LOCATION}envs/moplayground/dmcontrol/model/cheetah.xml')
